...
const ProjectDetailsModal = ({ project, onClose }) => {
    ...
    return (
        <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto backdrop-blur-md bg-black/60"
        >
            <motion.div
            ...
            >
                ...
                <div className="w-full md:w-[40%] flex flex-col p-4 md:p-6 bg-gradient-to-b from-orange-600 to-red-600 relative rounded-t-[2rem] md:rounded-l-[2rem] md:rounded-tr-none min-h-[300px] md:min-h-0">
                    <div className="absolute top-0 right-0 w-20 h-20 border-t-2 border-r-2 border-white/30 transform -translate-x-4 translate-y-4"></div>
                    ...
                    <div className="mt-auto bg-white rounded-lg p-2.5 w-full max-w-[240px] mx-auto opacity-95 hidden sm:block">
                        <div className="flex justify-between items-end h-10 gap-[2px]">
                            {/* Simple random lines for a barcode look */}
                            {[...Array(35)].map((_, i) => (
                ...
                <div className="w-full md:w-[60%] p-6 sm:p-8 flex flex-col justify-between text-white relative">
                    ...
                    <div className="mt-2 sm:mt-12 sm:pr-16">
                        <div className="mb-6">
                            ...
                            <h2 className="font-lexa text-3xl sm:text-4xl font-black uppercase leading-tight tracking-tight text-white mb-1">
                                {project.title}
                            </h2>
                        </div>

                        <div className="mb-6">
                            <span className="text-[10px] sm:text-xs font-monorama font-bold tracking-widest text-zinc-400 uppercase block mb-1">CATEGORY</span>
                            <div className="font-lexa text-xl sm:text-2xl font-bold tracking-wider text-orange-400">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {project.techStack?.map((tech) => (
                                    <span
                                        key={tech}
                                        className="px-3 py-1 text-xs font-medium rounded-md bg-zinc-800 border border-zinc-700 text-zinc-300"
                                    >
                                        {tech}
                                    </span>
                                ))}
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row items-center justify-between border-t border-zinc-800 pt-6">
                        <div className="flex items-center gap-4 mb-4 sm:mb-0">
                            {project.github && (
                                <a
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 bg-white text-black font-bold uppercase tracking-wider text-xs rounded-lg hover:bg-orange-500 hover:text-white transition-colors"
                                >
                            ...
                            {project.demo && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center gap-2 px-5 py-2.5 bg-transparent border-2 border-white text-white font-bold uppercase tracking-wider text-xs rounded-lg hover:bg-white hover:text-black transition-colors"
                                >
                        ...
                        <div className="hidden sm:flex flex-col items-center">
                            ...
                            <div className="font-['Stalemate',cursive,serif] text-3xl sm:text-4xl transform -rotate-6 text-white/90" style={{ fontFamily: 'var(--font-primary, cursive)' }}>
                                Vikash
                            </div>
                        </div>
                    </div>
