...
const GlobeIcon = ({
    ...
    <svg
        ...
        <path
            d="M12,2C6.5,2,2,6.5,2,12s4.5,10,10,10s10-4.5,10-10S17.5,2,12,2z M12,20c-4.4,0-8-3.6-8-8s3.6-8,8-8s8,3.6,8,8S16.4,20,12,20z" />
    </svg>
);
...
const FileIcon = ({
    ...
    <svg
        ...
        className={cn("w-full h-full fill-current", className)}>
        <path
            d="M2.3,0C1,0,0,1,0,2.3v22.2c0,1.2,1,2.3,2.3,2.3h15.4c1.2,0,2.3-1,2.3-2.3V6l-6-6H2.3z" />
...
const createCircularPositions = (count, radius = 120) => {
...
const DeviFolder = ({ images, isHovered, colors, sizes, label }) => {
    ...
    return (
        <div className="relative">
            ...
            <div
                ...
                {/* Back */}
                <div
                    className={cn("absolute inset-0 transition-colors duration-150", colors.back)}>
                    <FolderBackIcon />
                </div>
...
const RudrasFolder = ({ images, isHovered, colors, sizes, label }) => {
    const positions = createCircularPositions(images.length, 80);
    ...
    return (
        <div className="relative">
            ...
            <div
                ...
                {/* Paper Sheet Deco */}
                <div
                    className="absolute bottom-0.5 left-0.5 right-0.5 h-3/4 bg-white dark:bg-gray-200 rounded-lg" />
...
const ArdraFolder = ({ images, isHovered, colors, sizes, label }) => {
...
const ShaktiFolder = ({ images, isHovered, colors, sizes, label }) => {
    return (
        <motion.div
            className="relative"
...
const KuberaFolder = ({ images, isHovered, colors, sizes, label }) => {
    return (
        <div className="relative">
...
const HariFolder = ({ images, isHovered, colors, sizes, label }) => {
    ...
    return (
        <div className="relative">
            ...
            <motion.div
                ...
                {/* Paper Sheet Deco */}
                <div
                    className="absolute bottom-0.5 left-0.5 right-0.5 h-3/4 bg-white/80 rounded-lg" />
...
const RaviFolder = ({ images, isHovered, colors, sizes, label }) => {
    ...
    return (
        <div className="relative">
            ...
            <div className="relative cursor-pointer" style={{ perspective: "800px" }}>
                ...
                {/* Paper Sheet */}
                <div
                    className="absolute bottom-0.5 left-0.5 right-0.5 h-3/4 bg-white rounded-lg" />

                {/* Card Spread Previews */}
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[75px] h-[65px]">
...
const DurgaFolder = ({ files, isHovered, colors, sizes, label }) => {
    return (
        <div className="relative">
...
const NandiFolder = ({ files, isHovered, colors, sizes, label }) => {
    const fileColorMap = {
        txt: "fill-blue-300",
        gif: "fill-teal-400",
        mp3: "fill-amber-400",
